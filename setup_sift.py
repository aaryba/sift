...
# Import my DBModels
from sift_models import User, Role, VoteCategory, Config, VoteSummaryHistory,Points, db
import tempfile
import shutil
from datetime import datetime, timedelta  # to auto insert default dates
...
def init_db_and_first_user(user_datastore):
    ...
    # Add Demo Data : Starting from id 3 
    # SNAPSHOT 1
    list_of_demo_objs = []

    list_of_demo_objs.append(VoteSummaryHistory(voted_for_snap_date= (datetime.utcnow() - timedelta(minutes=10)),snapshot_id ='snap_1',voted_for_id =3,vote_positive_count = 10,vote_negative_count = 0,vote_pos_negative_sum = 10,vote_needs_support_count = 0))

    list_of_demo_objs.append(VoteSummaryHistory(voted_for_snap_date=datetime.utcnow() - timedelta(minutes=10),snapshot_id ='snap_1',voted_for_id =4,vote_positive_count = 0,vote_negative_count = 10,vote_pos_negative_sum = -10,vote_needs_support_count = 0))
    list_of_demo_objs.append(VoteSummaryHistory(voted_for_snap_date=datetime.utcnow() - timedelta(minutes=10),snapshot_id ='snap_1',voted_for_id =5,vote_positive_count = 0,vote_negative_count = 0,vote_pos_negative_sum = 0,vote_needs_support_count = 10))

    # SNAPSHOT 2
    list_of_demo_objs.append(VoteSummaryHistory(voted_for_snap_date=datetime.utcnow() - timedelta(minutes=5),snapshot_id ='snap_2',voted_for_id =3,vote_positive_count = 10,vote_negative_count = 5,vote_pos_negative_sum = 5,vote_needs_support_count = 0))
    list_of_demo_objs.append(VoteSummaryHistory(voted_for_snap_date=datetime.utcnow() - timedelta(minutes=5),snapshot_id ='snap_2',voted_for_id =4,vote_positive_count = 5,vote_negative_count = 10,vote_pos_negative_sum = -10,vote_needs_support_count = 0))
    list_of_demo_objs.append(VoteSummaryHistory(voted_for_snap_date=datetime.utcnow() - timedelta(minutes=5),snapshot_id ='snap_2',voted_for_id =5,vote_positive_count = 0,vote_negative_count = 0,vote_pos_negative_sum = 0,vote_needs_support_count = 5))

    # Add Points to Admin and Adam
    list_of_demo_objs.append(Points(awarded_date = datetime.utcnow(),awarded_to_id = 1,awarded_points=3))
    list_of_demo_objs.append( Points(awarded_date = datetime.utcnow(),awarded_to_id = 2,awarded_points=3))
    list_of_demo_objs.append(Points(awarded_date = datetime.utcnow(),awarded_to_id = 3,awarded_points=3))
    list_of_demo_objs.append(Points(awarded_date = datetime.utcnow(),awarded_to_id = 4,awarded_points=3))
    list_of_demo_objs.append(Points(awarded_date = datetime.utcnow(),awarded_to_id = 5,awarded_points=3))
    list_of_demo_objs.append(Points(awarded_date = datetime.utcnow(),awarded_to_id = 6,awarded_points=3))
    
    for obj in list_of_demo_objs:
        db.session.add(obj)    
