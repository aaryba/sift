...
A Web Application designed using Python and Flask libraries with Role based access for Principals/Administrators, Teachers and Students.
...
| Roles  |Access   |
|---|---|
| Admin  |Full access to all records, school and student level charts, student onboarding along with voting ability    |
| Teacher  | Limited access to school and student level charts along with voting ability|
| Student  | Voting ability and access to see their citizenship rewards.|
...
Confirm that sift.db SQLite database file is auto-created with sample data.
