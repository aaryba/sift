...
# config_instance = Config.query.first()
    ...
    def school_trend_sabs():
        ...
        vote_category_names = {
            'School SABS Scores': list_of_y_sabs,
        }
        ...
        if len(list_of_x_dates) > 0:
            ...
            # Convert dates to numerical format for plotting
            dates_num = date2num(list_of_x_dates)

            # Scatter plot of the original data
            scores = list_of_y_sabs
            dates = list_of_x_dates
            ax.scatter(dates, scores, color='blue', label='School SABS Scores')
